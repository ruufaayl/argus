...
const VARIANT_HOST_MAP: Record<string, string> = {
  'tech.argus.app': 'tech',
  'finance.argus.app': 'finance',
  'commodity.argus.app': 'commodity',
  'happy.argus.app': 'happy',
};
...
const VARIANT_OG: Record<string, { title: string; description: string; image: string; url: string }> = {
  ...
  commodity: {
    ...
    image: 'https://commodity.argus.app/favico/commodity/og-image.png',
  ...
  happy: {
    ...
    image: 'https://happy.argus.app/favico/happy/og-image.png',
