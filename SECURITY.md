...
1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/ruufaayl/argus/security/advisories/new) to submit your report directly through the repository.

2. **Direct Contact**: Alternatively, reach out to the repository owner [@ruufaayl](https://github.com/ruufaayl) directly through GitHub.
...
ARGUS is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- ARGUS aggregates publicly available OSINT data
...
- Vulnerabilities in the ARGUS codebase
