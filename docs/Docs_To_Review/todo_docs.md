...
- [ ] Nginx configuration (reference `deploy/nginx-argus.conf`)
- [ ] SystemD service setup (reference `deploy/argus-api.service`)
...
- [ ] Add entries for UI customizations on `feat/ui-customizations-argus` branch
