...
Comprehensive data model documentation for **ARGUS** — an AI-powered real-time global intelligence dashboard. This reference covers all TypeScript interfaces, data structures, and their relationships across the system.
...
|-----|----------|--------------|
| `argus-panel-spans` | `PANEL_SPANS_KEY` | `Record<string, number>` — panel ID → grid span (1–4) |
...
- Key prefix: `argus-persistent-cache:`
