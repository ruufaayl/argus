...
🌐 **[Live Demo: argus.app](https://argus.app)** | 💻 **[Tech Variant: tech.argus.app](https://tech.argus.app)**
...
![ARGUS Dashboard](images/new-argus.png)

## Platform Variants

ARGUS runs two specialized variants from a single codebase, each optimized for different monitoring needs:

| Variant | URL | Focus |
|---------|-----|-------|
| **🌍 ARGUS** | [argus.app](https://argus.app) | Geopolitical intelligence, military tracking, conflict monitoring, infrastructure security |
| **💻 Tech Monitor** | [tech.argus.app](https://tech.argus.app) | Technology sector intelligence, AI/startup ecosystems, cloud infrastructure, tech events |
...
The tech variant ([tech.argus.app](https://tech.argus.app)) provides specialized layers for technology sector monitoring.
...
The Service Status panel tracks the operational health of external services that ARGUS users may depend on.
...
// App.ts
const header = `ARGUS v${__APP_VERSION__}`;
```
...
- ✅ **Variant Switcher UI** - Compact orbital navigation between ARGUS and Tech Monitor
