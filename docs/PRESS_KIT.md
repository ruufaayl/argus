...
ARGUS runs five thematic variants from a single codebase, each tailored to a different audience:

| Variant | Domain | Focus |
|---------|--------|-------|
| **ARGUS** | argus.app | Geopolitics, military, conflicts, infrastructure |
| **Tech Monitor** | tech.argus.app | AI/ML, startups, cybersecurity, tech ecosystems |
| **Finance Monitor** | finance.argus.app | Markets, central banks, Gulf FDI, commodities |
| **Commodity Monitor** | commodity.argus.app | Mining, metals, energy, critical minerals |
| **Happy Monitor** | happy.argus.app | Good news, conservation, positive global trends |

### AI Intelligence Layer

ARGUS uses a multi-tier AI pipeline to process and summarize information:
...
ARGUS aggregates publicly available data from dozens of sources. No proprietary or classified information is used. Key source categories:
...
ARGUS serves several audiences:
...
| Feature | ARGUS | Traditional OSINT Tools | News Aggregators |
|---------|--------------|------------------------|-----------------|
...
- **Web**: Available at argus.app and variant subdomains
...
ARGUS is actively developed with planned expansions across several areas:
...
- **API access** for developers and organizations to integrate ARGUS data into their own tools
...
**Q: Where does ARGUS get its data?**
...
**Q: Does ARGUS track users or sell data?**
...
A: Yes. ARGUS is licensed under AGPL-3.0, meaning anyone can inspect, audit, modify, and redistribute the code. If you run a modified version as a service, you must share your modifications under the same license.

**Q: Who built this?**
A: ARGUS was created by ruufaayl. It is an independent project, not affiliated with any government, intelligence agency, or defense contractor.

**Q: Can I embed ARGUS or use its data in my reporting?**
A: The web interface can be referenced and linked in reporting. For data integration, an API tier is planned. Please attribute "ARGUS (argus.app)" when referencing the platform in published work.

**Q: How is this different from Janes, Palantir, or Dataminr?**
A: Those are enterprise products costing tens to hundreds of thousands of dollars per year, typically sold to governments and large corporations. ARGUS aims to democratize access to situational awareness by aggregating public data and using AI to make it digestible. It is open source, free to use, and designed for individual analysts and small teams, not just large organizations.
...
A: ARGUS is primarily a solo project by its creator, with occasional open-source contributions from the community.
...
- **GitHub**: github.com/ruufaayl/argus
- **Website**: argus.app

---

*This document was last updated March 2026. ARGUS is an independent, open-source project licensed under AGPL-3.0.*
