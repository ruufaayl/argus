# ARGUS — Community Promotion Guide

Thank you for helping spread the word about ARGUS! This guide provides talking points, must-see features, and visual suggestions to help you create compelling content for your audience.
...
**Longer description**: ARGUS aggregates 170+ news feeds, military tracking, financial markets, conflict data, protest monitoring, satellite imagery, and AI-powered analysis into a single unified dashboard with an interactive globe. Available as a web app, desktop app (macOS/Windows/Linux), and installable PWA.
...
| Link | Description |
|------|-------------|
| [argus.app](https://argus.app) | Main dashboard — geopolitics, military, conflicts |
| [tech.argus.app](https://tech.argus.app) | Tech variant — startups, AI/ML, cybersecurity |
| [finance.argus.app](https://finance.argus.app) | Finance variant — markets, exchanges, central banks |
| [GitHub](https://github.com/ruufaayl/argus) | Source code (AGPL-3.0) |
...
- **Name**: "ARGUS" (two words, capitalized)
- **Tagline**: "Real-time global intelligence dashboard"
- **License**: AGPL-3.0 (free and open source)
- **Creator**: Credit "ARGUS by ruufaayl" or link to the GitHub repo
...
We genuinely appreciate community members helping grow ARGUS's reach. Feel free to interpret these guidelines creatively — there's no strict template. The most compelling content comes from showing what YOU find most interesting or useful about the tool.
