  ...
  return {
    ...
    transformIndexHtml(html) {
      let result = html
        ...
        .replace(/"name": "ARGUS"/, `"name": "${activeMeta.siteName}"`)
        .replace(/"alternateName": "Argus"/, `"alternateName": "${activeMeta.siteName.replace(' ', '')}"`)
        .replace(/"url": "https:\/\/argus\.app\/"/, `"url": "${activeMeta.url}"`)
  ...
  async function buildRouter() {
    const [
      ...
      naturalServerMod, naturalHandlerMod,
        ...
        import('./src/generated/server/argus/seismology/v1/service_server'),
        import('./server/argus/seismology/v1/handler'),
        import('./src/generated/server/argus/wildfire/v1/service_server'),
        import('./server/argus/wildfire/v1/handler'),
        import('./src/generated/server/argus/climate/v1/service_server'),
        import('./server/argus/climate/v1/handler'),
        import('./src/generated/server/argus/prediction/v1/service_server'),
        import('./server/argus/prediction/v1/handler'),
        import('./src/generated/server/argus/displacement/v1/service_server'),
        import('./server/argus/displacement/v1/handler'),
        import('./src/generated/server/argus/aviation/v1/service_server'),
        import('./server/argus/aviation/v1/handler'),
        import('./src/generated/server/argus/research/v1/service_server'),
        import('./server/argus/research/v1/handler'),
        import('./src/generated/server/argus/unrest/v1/service_server'),
        import('./server/argus/unrest/v1/handler'),
        import('./src/generated/server/argus/conflict/v1/service_server'),
        import('./server/argus/conflict/v1/handler'),
        import('./src/generated/server/argus/maritime/v1/service_server'),
        import('./server/argus/maritime/v1/handler'),
        import('./src/generated/server/argus/cyber/v1/service_server'),
        import('./server/argus/cyber/v1/handler'),
        import('./src/generated/server/argus/economic/v1/service_server'),
        import('./server/argus/economic/v1/handler'),
        import('./src/generated/server/argus/infrastructure/v1/service_server'),
        import('./server/argus/infrastructure/v1/handler'),
        import('./src/generated/server/argus/market/v1/service_server'),
        import('./server/argus/market/v1/handler'),
        import('./src/generated/server/argus/news/v1/service_server'),
        import('./server/argus/news/v1/handler'),
        import('./src/generated/server/argus/intelligence/v1/service_server'),
        import('./server/argus/intelligence/v1/handler'),
        import('./src/generated/server/argus/military/v1/service_server'),
        import('./server/argus/military/v1/handler'),
        import('./src/generated/server/argus/positive_events/v1/service_server'),
        import('./server/argus/positive-events/v1/handler'),
        import('./src/generated/server/argus/giving/v1/service_server'),
        import('./server/argus/giving/v1/handler'),
        import('./src/generated/server/argus/trade/v1/service_server'),
        import('./server/argus/trade/v1/handler'),
        import('./src/generated/server/argus/supply_chain/v1/service_server'),
        import('./server/argus/supply-chain/v1/handler'),
        import('./src/generated/server/argus/natural/v1/service_server'),
        import('./server/argus/natural/v1/handler'),
      ]);
