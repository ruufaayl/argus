...
```typescript
// server/argus/forecast/v1/get-simulation-outcome.ts line 21
...
```typescript
// server/argus/forecast/v1/get-simulation-outcome.ts
...
- File: `server/argus/forecast/v1/get-simulation-outcome.ts` lines 21-23
- File: `server/argus/forecast/v1/get-simulation-package.ts` lines ~21-23 (same pattern)
