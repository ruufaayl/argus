...
## Technical Details
- Files: `server/argus/news/v1/summarize-article.ts:42`, `server/argus/intelligence/v1/deduct-situation.ts:26`, `server/argus/intelligence/v1/get-country-intel-brief.ts`
