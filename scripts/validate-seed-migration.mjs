 ...
 *
 * Requires: Referer header from trusted origin OR X-Argus-Key header.
 * Uses api.argus-intel.vercel.app by default.
 */

const BASE_URL = process.argv.includes('--base-url')
  ? process.argv[process.argv.indexOf('--base-url') + 1]
  : 'https://api.argus-intel.vercel.app';

const ORIGIN = 'https://argus-intel.vercel.app';
