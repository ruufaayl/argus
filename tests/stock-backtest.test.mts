...
import { backtestStock } from '../server/argus/market/v1/backtest-stock.ts';
import { listStoredStockBacktests } from '../server/argus/market/v1/list-stored-stock-backtests.ts';
import { MarketServiceClient } from '../src/generated/client/argus/market/v1/service_client.ts';
