...
const { searchGoogleFlights } = await import('../server/argus/aviation/v1/search-google-flights.ts');
const { searchGoogleDates } = await import('../server/argus/aviation/v1/search-google-dates.ts');
