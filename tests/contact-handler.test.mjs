...
function makeRequest(body, opts = {}) {
  return new Request('https://argus.app/api/contact', {
...
describe('api/contact', () => {
  ...
  describe('validation', () => {
    it('rejects GET requests', async () => {
      const res = await handler(new Request('https://argus.app/api/contact', {
        method: 'GET',
    ...
    it('rejects disallowed origins', async () => {
      const req = new Request('https://argus.app/api/contact', {
        method: 'POST',
