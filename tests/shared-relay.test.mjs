...
describe('getRelayHeaders — no auth', () => {
  ...
  it('aviation User-Agent override works', () => {
    const h = getRelayHeaders({ 'User-Agent': 'Argus-Server/1.0' });
    assert.equal(h['User-Agent'], 'Argus-Server/1.0');
  });
});
...
describe('relay.ts — consumer import verification', () => {
  const consumers = [
    { file: 'server/argus/aviation/v1/_shared.ts', importPath: '../../../_shared/relay' },
    { file: 'server/argus/intelligence/v1/_relay.ts', importPath: '../../../_shared/relay' },
    { file: 'server/argus/research/v1/list-tech-events.ts', importPath: '../../../_shared/relay' },
    { file: 'server/argus/maritime/v1/get-vessel-snapshot.ts', importPath: '../../../_shared/relay' },
    { file: 'server/argus/market/v1/_shared.ts', importPath: '../../../_shared/relay' },
    { file: 'server/argus/news/v1/list-feed-digest.ts', importPath: '../../../_shared/relay' },
    { file: 'server/argus/military/v1/list-military-flights.ts', importPath: '../../../_shared/relay' },
  ];
  ...
  it('no local getRelayBaseUrl/getRelayHeaders/getRelayRequestHeaders definitions in server/ (except _shared/relay.ts)', () => {
    const dupeFiles = [
      'server/argus/aviation/v1/_shared.ts',
      'server/argus/intelligence/v1/_relay.ts',
      'server/argus/research/v1/list-tech-events.ts',
      'server/argus/maritime/v1/get-vessel-snapshot.ts',
      'server/argus/market/v1/_shared.ts',
      'server/argus/news/v1/list-feed-digest.ts',
      'server/argus/military/v1/list-military-flights.ts',
    ];
  ...
  it('military list-military-flights.ts uses getRelayBaseUrl() not raw WS_RELAY_URL + /opensky', () => {
    const src = readFileSync(resolve('server/argus/military/v1/list-military-flights.ts'), 'utf-8');
    assert.ok(
