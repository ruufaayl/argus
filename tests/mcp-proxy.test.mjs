...
function makeGetRequest(params = {}, origin = 'https://argus.app') {
  const url = new URL('https://argus.app/api/mcp-proxy');
...
function makePostRequest(body = {}, origin = 'https://argus.app') {
  return new Request('https://argus.app/api/mcp-proxy', {
    method: 'POST',
...
function makeOptionsRequest(origin = 'https://argus.app') {
  return new Request('https://argus.app/api/mcp-proxy', {
    method: 'OPTIONS',
    headers: { origin },
  });
...
describe('api/mcp-proxy', () => {
  ...
  describe('CORS and method handling', () => {
    ...
    it('returns 405 for DELETE', async () => {
      const res = await handler(new Request('https://argus.app/api/mcp-proxy', {
        method: 'DELETE',
  ...
  describe('GET /api/mcp-proxy (list tools)', () => {
    ...
    it('ignores invalid JSON in headers param', async () => {
      ...
      const req = new Request(url.toString(), { method: 'GET', headers: { origin: 'https://argus.app' } });
