...
const clientGeneratedSrc = readFileSync(join(root, 'src/generated/client/argus/trade/v1/service_client.ts'), 'utf-8');
const serverGeneratedSrc = readFileSync(join(root, 'src/generated/server/argus/trade/v1/service_server.ts'), 'utf-8');
