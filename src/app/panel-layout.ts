...
export class PanelLayoutManager implements AppModule {
  ...
  private createPanels(): void {
    ...
    // VERITAS variant uses Groq-powered carbon brief; other variants keep the legacy multi-AI InsightsPanel
    if (SITE_VARIANT === 'full') {
      this.lazyPanel('insights', () =>
        import('@/components/VeritasInsightsPanel').then(m => new m.VeritasInsightsPanel()),
      );
    } else {
