...
export class App {
  ...
  constructor(containerId: string) {
    ...
    const storedVariant = localStorage.getItem('argus-variant');
    ...
    if (storedVariant !== currentVariant) {
      ...
      const PANEL_KEY_RENAMES_MIGRATION_KEY = 'argus-panel-key-renames-v2.6';
      ...
      const UNIFIED_MIGRATION_KEY = 'argus-unified-panels-v1';
      ...
      const HAPPY_PANEL_FIX_KEY = 'argus-happy-panel-fix-v1';
      ...
      const PANEL_ORDER_MIGRATION_KEY = 'argus-panel-order-v1.9';
      ...
      if (currentVariant === 'tech') {
        const TECH_INSIGHTS_MIGRATION_KEY = 'argus-tech-insights-top-v1';
    ...
    const PANEL_PRUNE_KEY = 'argus-panel-prune-v1';
    ...
    const LAYOUT_RESET_MIGRATION_KEY = 'argus-layout-reset-v2.5';
    ...
    if (currentVariant === 'full') {
      const baseKey = 'argus-sources-reduction-v3';
      ...
      const localeKey = `argus-locale-boost-${userLang}`;
