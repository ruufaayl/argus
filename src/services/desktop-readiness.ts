...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  ...
  },
  {
    ...
    apiHandlers: ['server/argus/conflict/v1/handler.ts', 'server/argus/infrastructure/v1/handler.ts', 'server/argus/cyber/v1/handler.ts', 'server/argus/maritime/v1/handler.ts', 'server/argus/military/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/argus/news/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/argus/market/v1/handler.ts'],
    locality: 'fully-local',
  ...
  },
  {
    ...
    apiHandlers: ['server/argus/military/v1/handler.ts'],
    locality: 'api-key',
