...
import { assembleAnalystContext } from '../server/argus/intelligence/v1/chat-analyst-context';
import { buildAnalystSystemPrompt } from '../server/argus/intelligence/v1/chat-analyst-prompt';
import { buildActionEvents } from '../server/argus/intelligence/v1/chat-analyst-actions';
  ...
  if (req.method === 'OPTIONS') {
    return new Response(null, {
      ...
      headers: {
        ...
        'Access-Control-Allow-Headers': 'Content-Type, Authorization, X-Argus-Key',
      },
    });
  }
