...
function htmlError(title, detail) {
  return new Response(`<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Error &#x2014; Argus MCP</title>
...
<body><a href="https://www.argus-intel.vercel.app" class="wm-logo" target="_blank" rel="noopener">${GLOBE_SVG}<span class="wm-logo-text">Argus MCP</span></a>
<div class="card"><h1>${escapeHtml(title)}</h1><p>${escapeHtml(detail)}</p><a href="javascript:history.back()" class="back">&#8592; go back</a></div>
<p class="footer"><a href="https://www.argus-intel.vercel.app" target="_blank" rel="noopener">argus-intel.vercel.app</a></p>
...
<title>Authorize &#x2014; Argus MCP</title>
<style>
...
<body>
<a href="https://www.argus-intel.vercel.app" class="wm-logo" target="_blank" rel="noopener">${GLOBE_SVG}<span class="wm-logo-text">Argus MCP</span></a>
<div class="card">
<div class="client-hd">
...
<hr>
<form id="cf" method="POST" action="https://api.argus-intel.vercel.app/oauth/authorize">
...
<p class="hint">No key? <a href="https://www.argus-intel.vercel.app/pro" target="_blank" rel="noopener">Get one at argus-intel.vercel.app/pro &#x2192;</a></p>
<p class="error" id="ke"${errorMsg ? '' : ' style="display:none"'}>${errorMsg ? escapeHtml(errorMsg) : ''}</p>
<button type="submit" id="ab">Authorize</button>
</form>
</div>
<p class="footer"><a href="https://www.argus-intel.vercel.app" target="_blank" rel="noopener">argus-intel.vercel.app</a> &middot; <a href="https://www.argus-intel.vercel.app/pro" target="_blank" rel="noopener">Get an API key &#x2192;</a></p>
...
export default async function handler(req) {
  ...
  if (method === 'POST') {
    ...
    if (origin && origin !== 'https://api.argus-intel.vercel.app' && origin !== 'null') {
