...
export default function handler(req, res) {
  const url = new URL(req.url, 'https://argus-intel.vercel.app');
  ...
  const baseUrl = 'https://argus-intel.vercel.app';
  ...
  const title = `${countryName} Intelligence Brief | ARGUS`;
...
<head>
  ...
  <meta name="twitter:site" content="@ArgusApp"/>
