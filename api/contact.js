...
async function sendNotificationEmail(name, email, organization, phone, message, ip, country) {
  ...
  const notifyEmail = process.env.CONTACT_NOTIFY_EMAIL || 'rufayl@argus-intel.vercel.app';
      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family: -apple-system, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p style="color: #999; font-size: 12px; margin-top: 24px;">Sent from argus-intel.vercel.app enterprise contact form</p>
          </div>`,
      }),
    });
    if (!res.ok) {
