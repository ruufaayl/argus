...
async function sendConfirmationEmail(email, referralCode) {
  const referralLink = `https://argus-intel.vercel.app/pro?ref=${referralCode}`;
  const shareText = encodeURIComponent('I just joined the ARGUS Pro waitlist \u2014 real-time global intelligence powered by AI. Join me:');
  ...
  const telegramShare = `https://t.me/share/url?url=${shareUrl}&text=${encodeURIComponent('Join the ARGUS Pro waitlist:')}`;
  ...
  try {
    const resendRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'ARGUS <noreply@argus-intel.vercel.app>',
        to: [email],
        subject: 'You\u2019re on the ARGUS Pro waitlist',
        html: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #e0e0e0;">
            ...
            <div style="padding: 40px 32px 0;">
              ...
              <div style="text-align: center; margin-bottom: 36px;">
                <a href="https://argus-intel.vercel.app" style="display: inline-block; background: #4ade80; color: #0a0a0a; padding: 14px 36px; text-decoration: none; font-weight: 800; font-size: 13px; text-transform: uppercase; letter-spacing: 1.5px; border-radius: 2px;">Explore the Free Dashboard</a>
            ...
            <div style="border-top: 1px solid #1a1a1a; padding: 24px 32px; text-align: center;">
              ...
              <p style="font-size: 11px; color: #444; margin: 0; line-height: 1.6;">
                ARGUS \u2014 Real-time intelligence for a connected world.<br />
