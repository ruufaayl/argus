...
const ALLOWED_ORIGINS = [
  /^https:\/\/(.*\.)?argus\.app$/,
  /^https:\/\/argus-[a-z0-9-]+-elie-habib-projects\.vercel\.app$/,
  /^https:\/\/argus-[a-z0-9-]+\.vercel\.app$/,
  /^https?:\/\/localhost(:\d+)?$/,
  /^https?:\/\/127\.0\.0\.1(:\d+)?$/,
  /^tauri:\/\/localhost$/,
];
...
function sanitizeOrigin(raw) {
  return sanitizeAllowedOrigin(raw, 'https://argus-intel.vercel.app', ALLOWED_ORIGINS);
}
